...
exports.getAssetlocation = async(req, res, next) => {
    ...
    try {
        ...
        res.render(viewName+"asset/assetlocation", {locList: row2, liRow : paginate.pages[paginate.page - 1], pages : paginate.threePages});
    } catch (err) {
        console.log(err);
        res.render(viewName+"asset/assetlocation",{locList : null, liRow : "1", pages : "1"});
    }
...
exports.getAssethistory = async(req, res, next) => {
    ...
    try{
        ...
        res.render(viewName+"asset/assethistory", {locList: row2, liRow: paginate.pages[paginate.page - 1], pages: paginate.threePages});
...
exports.getAssetcalandar = async(req, res, next) => {
    ...
    res.render(viewName+"asset/assetcalandar", {loc_seq: info.loc_seq, loc_nm: row1[0].loc_nm, btryList: row2});
}
