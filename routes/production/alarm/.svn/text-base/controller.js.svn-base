...
const viewName = 'production/alarm/alarm';
require("date-utils");
...
exports.getAlarm = async(req, res, next) => {
    ...
    try {
        ...
        console.log(error);
        return form.result(res, req.method, 'FAIL', null, '서버 오류 발생', null, '/production/dashboard');
    }
...
exports.postSetAlarm = async(req, res, next) => {
    ...
    return form.result(res, req.method, 'SUCCESS', null, '알람을 설정하였습니다.', null, '/production/alarm');
}
