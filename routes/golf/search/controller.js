...
exports.getBtryDetail = async (req, res, next) => {
    ...
    if (!Number.isInteger(btrySeq)) {
        return form.result(res, req.method, 'FAIL', null, '잘못된 파라미터입니다', null, '/golf/search/battery');
    }
...
exports.postBtryDetailInfo = async (req, res, next) => {
    ...
    if (!btryInfo) return form.result(res, req.method, 'FAIL', null, '해당되는 데이터가 없습니다', null, '/golf/search/battery');
...
exports.getBtryDetailTest = async (req, res, next) => {
    ...
    if (!Number.isInteger(btrySeq)) return form.result(res, req.method, 'FAIL', null, '잘못된 파라미터입니다', null, '/golf/search/battery');
...
exports.postBtryDetailGraph = async (req, res, next) => {
    ...
    if (!Number.isInteger(btrySeq) || !Number.isInteger(dth)) return form.result(res, req.method, 'FAIL', null, '잘못된 파라미터입니다', null, '/golf/search/battery');
    ...
    if (!btryDthList) return form.result(res, req.method, 'FAIL', null, '해당되는 데이터가 없습니다', null, '/golf/search/battery');
...
exports.postBtryDetailDaily = async (req, res, next) => {
    ...
    if (!Number.isInteger(btrySeq) || !Number.isInteger(page)) return form.result(res, req.method, 'FAIL', null, '잘못된 파라미터입니다', null, '/golf/search/battery');
    if (page <= 0) page = 1;
    ...
    if (!dailyInfo) return form.result(res, req.method, 'FAIL', null, '해당되는 데이터가 없습니다', null, '/golf/search/battery');
...
exports.postBtryDetailPeriod = async (req, res, next) => {
    ...
    if (!Number.isInteger(btrySeq) || !dt.isValid() || !Number.isInteger(page)) return form.result(res, req.method, 'FAIL', null, '잘못된 파라미터입니다', null, '/golf/search/battery');
    // if (page <= 0) page = 1;
