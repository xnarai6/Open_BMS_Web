...
exports.getHealth = async(req, res, next) => {
    ...
    try {
       ...
       // console.log("query2:"+query2)
        ...
        res.render("analytics/health", {locList: row2, liRow : paginate.pages[paginate.page - 1], pages : paginate.threePages});
    } catch (err) {
        console.log(err);
        res.render("analytics/health",{locList : null, liRow : "1", pages : "1"});
    }
}
