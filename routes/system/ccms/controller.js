...
exports.getCartList = async(req, res, next) => {
    ...
    res.render(viewName+"ccms/cart/list", {entire_no: entire_no, y_no: y_no, n_no: n_no, c_no: c_no});
}
...
exports.getCorsStat = async(req, res, next) => {
  ...
  //  console.log("query2:"+query2);
    ...
    res.render(viewName+"ccms/cors/stat", {corsList: row1, corsGroupList: array1, cartList:row2, cartList2: array2});
}
...
exports.getCcList = async(req, res, next) => {   
    ...
    res.render(viewName+"ccms/cc/ccList",{ccList: row2,liRow: paginate.pages[paginate.page - 1],pages: paginate.threePages});
}
...
exports.getCorsList = async(req, res, next) => {   
    ...
    res.render(viewName+"ccms/cc/corsList",{corsList: row2,liRow: paginate.pages[paginate.page - 1],pages: paginate.threePages});
}
...
exports.getCartdetail = async(req, res, next) => {
    ...
    res.render(viewName+"ccms/cart/cartdetail");
}