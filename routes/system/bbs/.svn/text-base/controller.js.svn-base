...
exports.getFaq = async(req, res, next) => {
    ...
    try {
        ...
        res.render(viewName+"bbs/faq",{faqList : row2, liRow : paginate.pages[paginate.page - 1], pages : paginate.threePages});
    } catch (error) {
        
        console.log(error);
        res.render(viewName+"bbs/faq",{faqList : null, liRow : "1", pages : "1"});
...
exports.getQna = async(req, res, next) => {
    ...
    try {
        ...
        res.render(viewName+"bbs/qna",{qnaList : row2, liRow : paginate.pages[paginate.page - 1], pages : paginate.threePages});
    } catch (error) {
        
        console.log(error);
        res.render(viewName+"bbs/qna",{qnaList : null, liRow : "1", pages : "1"});
...
exports.getQnaView = async(req, res, next) => {
    ...
    try {
        ...
        res.render(viewName+"bbs/qnaView",{qnaView : row1});
    } catch (error) {
        
        console.log(error);
        res.status(err.status || 500);
        res.render(viewName+'common/error');
...
exports.getQnaReg = (req, res, next) => {
    res.render(viewName+"bbs/qnaReg");
}
...
exports.getPricing = (req, res, next) => {
    res.render(viewName+"bbs/pricing");
}