...
exports.getDashboard =async(req, res, next) => {
    ...
    res.render(viewName+"dashboard/index", {BMS_LOCATION:mRows,BMS_LIST:mRows1,WEATHER_LIST:wRows, locSOH: rows3, today: today, lastweek: lastweekday});
}
...
exports.getIndivBatteryLog = async(req, res, next) => {
    ...
    try{
        ...
        res.render(viewName+"dashboard/indivbatterylog", {locList: row2, liRow: paginate.pages[paginate.page - 1], pages: paginate.threePages, btry_seq : btry_seq, btry_info: row3});
    }catch(err) {
        console.log(err);
...
exports.getViewProfile =async(req, res, next) => {
    ...
    try{
        ...
        res.render(viewName+"dashboard/viewProfile",{acntInfo : row, cmpyTyList : row1, roleList : row2, cmpyList: row3});
    }catch (error) {
        console.log(error);
        res.render(viewName+"dashboard/viewProfile",{acntInfo : null, cmpyTyList : null, roleList : null, cmpyList: null});
    }
