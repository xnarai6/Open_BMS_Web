...
router.route('/battery/list')
    .get(common.readDashCard, controller.getBatteryList);

router.route('/battery/detail/:batterySeq')
    .get(common.readDashCard, controller.getBatteryDetail);

router.route('/battery/detail/:batterySeq/format')
    .get(common.readDashCard, controller.getBatteryFormat);

router.route('/battery/detail/:batterySeq/format/data')
    .post(controller.postFormatData);
